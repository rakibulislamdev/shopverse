...
export default function CreateStore() {
    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data.status)) {
        ...
        switch (data.status) {
          ...
          case "rejected":
            setMessage(
              "Your store has been rejected. contact the admin for more info."
            );
            break;
          case "pending":
            setMessage(
              "Your store request is pending. please wait for approval."
            );
  ...
  if (!user) {
    return (
      <div className="mx-6 min-h-[70vh] my-16 flex items-center justify-center">
